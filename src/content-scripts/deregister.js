...
} else if (document.getElementsByClassName('OraTableContent').length > 1
    && document.getElementsByClassName('OraError').length === 0) {
  const rows = document.getElementsByClassName('OraTableContent')[0].children[0].children;
 ...
 * @param {array} rows The rows of the table, which has available exams in it.
 * @return {array}     An array of exam objects.
 */
